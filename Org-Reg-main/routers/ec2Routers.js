...
route.post('/awsAutomation', (req, res) => {
    ...
    let instanceId, elasticIP, s3Location;
    let SecurityGroupId;
    console.log(domainName);

    ec2Controller.updateUserData(userData,domainName,otherDomain).then((data,err)=>{
        console.log(data);
        console.log("Success in replacing!");
        ...
        elasticIP = paramsAssociateAddress.AllocationId;
        console.log(elasticIP);
        ...
        console.log("Output after s3 Creation",data);
        S3Location = JSON.stringify(data.s3.Location);
        var params = {
        ...
        RDSInstance = JSON.stringify(createRDSInstance.Data.DBInstance.DBInstanceIdentifier);
        let data={
            "Key Pair Name": name, 
            "Instance ID": instanceId, 
            "Security Group": SecurityGroupId,
            "Elastic IP Group": elasticIP, 
